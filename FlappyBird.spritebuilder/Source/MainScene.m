...
- (void)didLoadFromCCB {
    ...
    pysicsNode.collisionDelegate = self;
...
- (void)addObstacle {
    ...
    CGPoint worldPosition = [pysicsNode convertToNodeSpace:screenPosition];
    obstacle.position = worldPosition;
    [obstacle setupRandomPosition];
    obstacle.zOrder = DrawingOrderPipes;
    [pysicsNode addChild:obstacle];
...
- (void)update:(CCTime)delta
{
    ...
    pysicsNode.position = ccp(pysicsNode.position.x - (character.physicsBody.velocity.x * delta), pysicsNode.position.y);
    
    // loop the ground
    for (CCNode *ground in _grounds) {
        // get the world position of the ground
        CGPoint groundWorldPosition = [pysicsNode convertToWorldSpace:ground.position];
    ...
    for (CCNode *obstacle in _obstacles) {
        CGPoint obstacleWorldPosition = [pysicsNode convertToWorldSpace:obstacle.position];
